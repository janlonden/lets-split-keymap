...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [COLEMAK_SOFT] = LAYOUT( \
    SPACE__BROWSER, CM_G, CM_D, CM_B, RALT_O, _______, _______, _______, KC_COMMA, SHIFT__RIGHT_LAYERS, KC_DOT, TG(NUMBERS), \
  ...
  [COLEMAK_HARD] = LAYOUT( \
    SPACE__BROWSER, KC_G, KC_D, KC_B, XXXXXXX, _______, _______, _______, KC_COMMA, SHIFT__RIGHT_LAYERS, KC_DOT, TG(NUMBERS), \
  ...
  [NUMBERS] = LAYOUT( \
    ...
    _______, _______, KC_LEFT, ALT_TAB, _______, _______, _______, _______, KC_4, KC_5, KC_6, _______, \
